                                                ...
                                                <form class="user" enctype="multipart/form-data" method="POST" action="/admin/add_product">
                                                    <div class="form-group row">
                                                        <div class="col-sm-12 mb-3 mb-sm-0">
                                                            <input type="text" name="product_name" required class="form-control form-control-user" id="exampleFirstName" placeholder="Tên sản phẩm">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="form-group row">
                                                            <input accept="image/*" name="image" class="image" required type='file' id="imgInp" />
