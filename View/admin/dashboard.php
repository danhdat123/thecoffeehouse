                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/admin/form_edit_product/<?php echo $products[$i]['id'] ?>" class="btn btn-warning mr-3">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="/admin/delete_product/<?php echo $products[$i]['id'];?>" class="btn btn-danger" >
